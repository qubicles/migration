...
class SwitchNetworkNotice extends Component {
  render () {
    ...
    return (
      <div>
        <h1>Migrate Qubicles to Telos (EOS.IO)</h1>
        <h2>Wrong Network Detected</h2>
        <p>You have {this.nameForNetwork(net)} selected, but this token requires {this.nameForNetwork(tokenNet)}. Please switch the current network in MetaMask.</p>
